...
<script type="text/javascript">
	$(function() {
		...
		$("select").multiselect({
			close : function() {
				...
				document.getElementById("skillarray").value = values;
				/* 				alert(values);
				 */
			}
	...
	function val() {
		...
		if (document.getElementById("skillarray").value == "") {
			alert("You haven't selected a skill. Please select atlest one skill.");
			return false;
		}
		return true;
	}
