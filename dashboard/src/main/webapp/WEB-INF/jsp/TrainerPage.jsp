        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand">
                    <a href="#">
                       Trainer Id:&nbsp<%=session.getAttribute("pId") %>
                    </a>
                </li>
                <li>
<a href="#" onclick="func('SkillSelect.html')">Skill Select</a>
                </li>
                <li>
<a href="#" onclick="func('ViewSkill.html')">View Skill</a>
                </li>
                <li>
<a href="#" onclick="func('addEvent.html')">Add Event</a>
                </li>
                <li>
<a href="#" onclick="func('completionStatus.html')">Completion Status</a>
                </li>
                <li>
<a href="#" onclick="func('terminateevent.html')">Terminate Event</a>
                </li>
                <li>
<a href="#" onclick="func('broadcast.html')">Broadcast</a>
                </li>
                <li>
