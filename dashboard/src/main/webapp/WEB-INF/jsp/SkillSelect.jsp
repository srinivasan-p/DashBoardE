...
<link rel="stylesheet" type="text/css" href="../dashboard/assets/jquery.multiselect.css" />
<script type="text/javascript" src="../dashboard/assets/jquery.multiselect.js"></script>
...
<body>
	...
	<form action="SkillSelect.html" method="POST">
		<p>
			<select name="example-list" multiple="multiple" style="width: 400px">
				<%
					...
					PreparedStatement pre = Conn.prepareStatement(
							"SELECT skillid, skillName FROM newdb.db_skill where skillid not in (SELECT skillid FROM newdb.db_studskill where pId=2)");
			...
			<input type="text" id="skillarray" name="skillarray"> 
			<input type="submit">
		</p>
