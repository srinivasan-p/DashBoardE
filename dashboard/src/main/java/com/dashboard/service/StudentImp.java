...
//		try
//		{
//			if((patientBean.equals(null)) || (patientBean.getAilmentDetails().equalsIgnoreCase(null)) ||  patientBean.getAilmentDetails().equalsIgnoreCase("")  || (patientBean.getAilmentType().equalsIgnoreCase(null)) ||  patientBean.getAilmentType().equalsIgnoreCase("")   ||  patientBean.getDiagnosisHistory().equalsIgnoreCase("")  ||  patientBean.getDiagnosisHistory().equalsIgnoreCase(null)  )
//			{
//				return "FAIL";	
//			}
//			else
...
//		try
//		{
//			if((patientBean==null) || (patientBean.getAilmentDetails().equalsIgnoreCase(null)) ||  patientBean.getAilmentDetails().equalsIgnoreCase("")  || (patientBean.getAilmentType().equalsIgnoreCase(null)) ||  patientBean.getAilmentType().equalsIgnoreCase("")  ||  patientBean.getDiagnosisHistory().equalsIgnoreCase("")  ||  patientBean.getDiagnosisHistory().equalsIgnoreCase(null)  )
//			{
//				return false;	
//			}
//			else
...
//			
//		
//		if(doctorID.equalsIgnoreCase(null) || doctorID.equals("") || appointmentDate.equals(null) || specialization.equalsIgnoreCase(null) || specialization.equals("") )
//		{
//			
//			return null;	
//		}
//		else
//		{
//		String result = patientDAO.requestforAppointment(doctorID, appointmentDate,userID,specialization);
//		
//		return result;
//		}
//		}
...
//		else
//		{
//		Map<AppointmentBean, PatientBean> map= patientDAO.viewAppointmentDetails(patientID, date);
//		return map;
//		
//		}
//		}
