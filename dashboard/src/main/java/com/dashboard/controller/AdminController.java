...
//			BindingResult bindingResult,@RequestParam("file") MultipartFile file,HttpSession httpSession) throws IOException 
//	{
...
//		}
//
//		Path path = Paths.get("C:/Users/Lenovo/Desktop/Team Project/TeamProject/WebContent/Default.jpg");
...
//			}
//		else{
//				//FileInputStream file1 = new FileInputStream("F:/OnlineClinicSystemProject/TeamProject/WebContent/Default.jpg");
//				
...
//	public String setPostDate(HttpSession session,HttpServletRequest req,HttpServletResponse res, Model model) 
//	{
//		String sdate = req.getParameter("date");
//		Date date = null;
//		System.out.println(sdate);
//		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");//change one
//		try 
//		{
...
//		Map<PatientBean, AppointmentBean> var = AdminService.viewPatientsByDate(date);
...
//	public String addValues(HttpSession session,@ModelAttribute("AddDoctorAtrrobute")   @Valid  DoctorBean AddDoctor,BindingResult bindingResult,@RequestParam("file") MultipartFile file ) throws IOException
//	{
//		if (bindingResult.hasErrors()) 
//		{
//
...
//			System.out.println("if photo is null for add doctor in admin controller is not null");
//		}
//		else{
//			/*MultipartFile result = new MockMultipartFile(name,
...
//			FileInputStream file1 = new FileInputStream("F:/OnlineClinicSystemProject/TeamProject/WebContent/Default.jpg");
//			FileOutputStream file3=new FileOutputStream("F:/OnlineClinicSystemProject/TeamProject/WebContent/Default.jpg");
//			MultipartFile multipartFile = (MultipartFile) file1;*/
//			
...
//	public String deleteValues(HttpSession se ,@ModelAttribute("DeleteDoctorAtrrobute")  DoctorBean deleteDoctor)
//	{
...
//	public ModelAndView modify1Values(HttpSession session,HttpServletRequest req,Model model){
...
//		session.setAttribute("YearsOfExperience", docBean.getYearsOfExperience());
...
//	public String modifyUpdateValues(HttpSession session,HttpServletRequest req,Model model,@ModelAttribute("modelmodify")  @Valid DoctorBean ModifyDoctor,BindingResult bindingResult)
//	{
//		
//		if (bindingResult.hasErrors()) 
//		{
...
//	@Transactional(propagation=Propagation.REQUIRED,readOnly=false)
//	public ModelAndView delete1Values(HttpSession session,PrintWriter out, Model model)
//	{
//		DoctorBean registrationBean = new DoctorBean();
//		model.addAttribute("DeleteDoctorAtrrobute", registrationBean);
//		Session ses = sessionFactory.getCurrentSession();
...
//	@Transactional(propagation=Propagation.REQUIRED,readOnly=false)
//	public String deletValues(HttpSession session,HttpServletRequest req,Model model)
//	{
//		DoctorBean registrationBean = new DoctorBean();
//		model.addAttribute("DeleteDoctorAtrrobute", registrationBean);
//		
...
//	}
//	
//	@RequestMapping(value = "/suggestionFromReporter", method = RequestMethod.GET)
//	public String displayPatientIDAndAppointments(){
//		
//		return "suggestionFromReporter";
//	}
//	
//	@RequestMapping(value = "/suggestionFromReporter", method = RequestMethod.POST)
//	public ModelAndView PatientIDAndAppointments(HttpSession session,HttpServletRequest req,HttpServletResponse res, Model model) throws Exception
//	{
...
//		ArrayList<DoctorBean> doctors =AdminService.suggestDoctors(patientID, date);
...
//	@Transactional(propagation=Propagation.REQUIRED,readOnly=false)
//
//	public String suggesteddoctor(HttpSession session,HttpServletRequest req,HttpServletResponse res, Model model) throws Exception
//	{
//		Session sess = sessionFactory.getCurrentSession();
//		String patientID = (String) session.getAttribute("patientID");
//		Query query = sess.createSQLQuery("select userid from OCS_TBL_PATIENT where PATIENTID =?");
...
//		
////		Query query2 = sess.createSQLQuery("select APPOINTMENTDATE from OCS_TBL_APPOINTMENTS where PATIENTID =? and DOCTORID=?");
...
//		org.hibernate.classic.Session hibernateSecs = sessionFactory.getCurrentSession();
//		try
//		{
//		SQLQuery query = hibernateSecs.createSQLQuery("select emailid from OCS_TBL_DOCTOR where emailid=:mail");
...
//	public @ResponseBody String getResponseForProfile(HttpServletRequest request,HttpServletResponse response){
//		String mailId= request.getParameter("mail");
//		org.hibernate.classic.Session hibernateSecs = sessionFactory.getCurrentSession();
//		try
//		{
//		SQLQuery query = hibernateSecs.createSQLQuery("select emailid from OCS_TBL_USER_PROFILE where emailid=:mail");
//		query.setParameter("mail", mailId);
//	if(	query.list().size()>0)
//	{
//	return "Please Try with different mailId";
